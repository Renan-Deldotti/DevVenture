package com.teste.implicitintents;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void accessWebsite(View view) {
        String url = editTextWebAddress.getText().toString().trim();
    ...
    private void checkAppsForIntent(Intent intent){
        if (intent.resolveActivity(getPackageManager()) != null){
            ...
            Toast.makeText(this, "There's no app available.", Toast.LENGTH_SHORT).show();
        }
    }
}
